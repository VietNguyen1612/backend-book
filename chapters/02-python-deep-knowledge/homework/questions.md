...
## Internals: Mini-ORM (Descriptors + Metaclass)

Build a miniature ORM where typed fields (`StringField`, `IntField`) use the descriptor protocol for validated attribute access, and a metaclass gathers the declared fields off each `Model` subclass.
**Implement in**: `custom_orm.py`
