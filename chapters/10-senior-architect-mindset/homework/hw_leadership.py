"""Leadership Homework: ADR Generator.

Write a function that outputs a formatted Architecture Decision Record (ADR)
as a Markdown string from its core sections.
"""
